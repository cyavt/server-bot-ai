-- Đảm bảo cột model_name đủ lớn trước khi INSERT dữ liệu
...
('SYSTEM_ASR_AliyunBLStream', 'ASR', 'aliyunbl_stream', 'Paraformer Alibaba Bách Luyện (realtime)', '[{"key":"api_key","label":"Khóa API","type":"password"},{"key":"model","label":"Tên mô hình","type":"string"},{"key":"format","label":"Định dạng âm thanh","type":"string"},{"key":"sample_rate","label":"Tần số lấy mẫu","type":"number"},{"key":"output_dir","label":"Thư mục đầu ra","type":"string"}]', 18, 1, NOW(), 1, NOW());
