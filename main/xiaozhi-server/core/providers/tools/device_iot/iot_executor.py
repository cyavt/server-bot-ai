"""Trình thực thi công cụ IoT phía thiết bị"""
...
class DeviceIoTExecutor(ToolExecutor):
    ...
    async def execute(
        ...
        try:
            # Phân tích tên công cụ, lấy tên thiết bị và loại thao tác
            if tool_name.startswith("get_"):
                ...
                if len(parts) >= 2:
                    ...
                    response_success = arguments.get("response_success", "Thao tác thành công")

                    # Xử lý placeholder trong phản hồi
    ...
    async def _send_iot_command(
        ...
        raise Exception(f"Không tìm thấy phương thức {method_name} của thiết bị {device_name}")
        ...
        for descriptor in descriptors:
                        ...
                        "function": {
                            ...
                            "parameters": {
                                ...
                                "properties": {
                                    "response_success": {
                                        "type": "string",
                                        "description": f"Phản hồi thân thiện khi truy vấn thành công, phải sử dụng {{value}} làm placeholder để biểu thị giá trị đã truy vấn",
                                    },
                                    "response_failure": {
                                        "type": "string",
                                        "description": f"Phản hồi thân thiện khi truy vấn thất bại",
                                    },
                                },
            ...
            if "methods" in descriptor:
                for method_name, method_info in descriptor["methods"].items():
                    ...
                    # Thêm tham số gốc của phương thức
                    ...
                    parameters.update(
                        {
                            "response_success": {
                                "type": "string",
                                "description": "Phản hồi thân thiện khi thao tác thành công",
                            },
                            "response_failure": {
                                "type": "string",
                                "description": "Phản hồi thân thiện khi thao tác thất bại",
                            },
                        }
                    )
    ...
    def has_tool(self, tool_name: str) -> bool:
        """Kiểm tra xem có công cụ IoT phía thiết bị được chỉ định không"""
