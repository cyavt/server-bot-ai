...
class Dialogue:
    ...
    def get_llm_dialogue(self) -> List[Dict[str, str]]:
        ...
        # Điều này đảm bảo chức năng nhận diện người nói hoạt động trên tất cả các đường dẫn gọi
    ...
    def get_llm_dialogue_with_memory(
        ...
        # Thêm prompt hệ thống và bộ nhớ
        system_message = next(
        ...
        if system_message:
            ...
            try:
                ...
                # Bỏ qua lỗi khi đọc cấu hình, không ảnh hưởng đến các chức năng khác
                pass

            # Sử dụng biểu thức chính quy để khớp thẻ <memory>, bất kể nội dung ở giữa là gì
        ...
        # Thêm cuộc hội thoại của người dùng và trợ lý
