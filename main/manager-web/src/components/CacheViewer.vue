...
export default {
  ...
  methods: {
    async loadCacheData() {
      ...
      try {
        // Đầu tiên kiểm tra xem có hỗ trợ API cache không
        if (!('caches' in window)) {
